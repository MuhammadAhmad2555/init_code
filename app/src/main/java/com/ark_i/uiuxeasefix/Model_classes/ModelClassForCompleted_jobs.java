...
public class ModelClassForCompleted_jobs {
    ModelClassForCompleted_jobs(){}


    public ModelClassForCompleted_jobs(String fromDestination, String toDestination, String status, String numBags, String numberofPeople, String idk, String departsdatetime, String type) {
